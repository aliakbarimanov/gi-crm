...
const Form = () => {
  return (
    <div className="bg-white px-10 py-20 rounded-3xl">
      <h1 className="text-5xl ">SaleSkip</h1>
      ...
      <div className="mt-8">
        ...
        <div>
          <div className="mt-8 flex flex-col gap-y-4">
            <button className=" active:scale-[.98] active:duratione-75 hover:scale-[1.01] ease-in-out  transition-all  py-3 rounded-xl bg-violet-500 text-white text-lg font-bold">
              Login Now
            </button>
