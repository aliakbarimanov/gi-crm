      ...
      <form>
        <div className="flex mb-10">
          <div className="flex flex-col mr-10">
            <label htmlFor="email" className="mb-2.5 font-bold text-slate-500">Email:</label>
            <input type="email" id="email" className="email p-1 border-2 rounded-md"  placeholder="jane.doe@gmail.com"/>
          </div>
          <div className="flex flex-col">
            <label htmlFor="current-password" className="mb-2.5 font-bold text-slate-500">Current password:</label>
            <input
              type="password"
              id="current-password"
        ...
        <div className="flex">
          <div className="flex flex-col mr-10">
            <label htmlFor="new-password" className="mb-2.5 font-bold text-slate-500">New password:</label>
            <input type="password" id="new-password" className="new-password p-1 border-2 rounded-md" />
          </div>
          <div className="flex flex-col">
            <label htmlFor="retry-password" className="mb-2.5 font-bold text-slate-500">Retry password:</label>
            <input
              type="password"
              id="retry-password"
